...
ffmpeg -i stimuli/audio/Ambush\ in\ Rattlesnake\ Gulch.mp3 -t 60 stimuli/audio/Ambush_in_Rattlesnake_Gulch.wav
mv stimuli/audio/Ambush\ in\ Rattlesnake\ Gulch.mp3 stimuli/audio/original_files/

ffmpeg -i stimuli/audio/Bleu.mp3 -t 60 stimuli/audio/Bleu.wav
mv stimuli/audio/Bleu.mp3 stimuli/audio/original_files/

ffmpeg -i stimuli/audio/Bollywood\ Groove.mp3 -t 60 stimuli/audio/Bollywood_Groove.wav
mv stimuli/audio/Bollywood\ Groove.mp3 stimuli/audio/original_files/

ffmpeg -i stimuli/audio/Breaking\ Bollywood.mp3 -t 60 stimuli/audio/Breaking_Bollywood.wav
...
ffmpeg -i stimuli/audio/Cumbish.mp3 -t 60 stimuli/audio/Cumbish.wav
mv stimuli/audio/Cumbish.mp3 stimuli/audio/original_files/

ffmpeg -i stimuli/audio/Desert\ Conflict.mp3 -t 60 stimuli/audio/Desert_Conflict.wav
mv stimuli/audio/Desert\ Conflict.mp3 stimuli/audio/original_files/

ffmpeg -i stimuli/audio/Funshine.mp3 -t 60 stimuli/audio/Funshine.wav
...
ffmpeg -ss 2.5 -i stimuli/audio/Jack\ The\ Lumberer.mp3 -t 62.5 stimuli/audio/Jack_The_Lumberer.wav
...
ffmpeg -i stimuli/audio/Shenzhen\ Nightlife.mp3 -t 60 stimuli/audio/Shenzhen_Nightlife.wav
...
ffmpeg -i stimuli/audio/Ukulele\ Song.mp3 -t 60 stimuli/audio/Ukulele_Song.wav
